export const abi = [
  ...
  'event CreateDLC(bytes32 uuid, address creator, uint256 emergencyRefundTime, uint256 nonce, string eventSource)',
  ...
  'event PostCreateDLC(bytes32 uuid, address creator, uint256 emergencyRefundTime, uint256 nonce, string eventSource)',
  ...
  'function dlcs(bytes32) view returns (bytes32 uuid, uint256 emergencyRefundTime, address creator, uint256 outcome, uint256 nonce)',
  'function getAllUUIDs() view returns (bytes32[])',
  'function getBTCPriceWithCallback(bytes32 _uuid) returns (int256)',
  'function getDLC(bytes32 _uuid) view returns (tuple(bytes32 uuid, uint256 emergencyRefundTime, address creator, uint256 outcome, uint256 nonce))',
  ...
  'function postCreateDLC(bytes32 _uuid, uint256 _emergencyRefundTime, uint256 _nonce, address _creator)',
