        ...
        switch (walletType) {
            case 'metamask':
                setupVault(vaultContract).then(() =>
                    dispatch(toggleDepositModalVisibility(false))
                );
                break;
            default:
                    ...
                    <ModalBody>
                            ...
                            <VStack width={350}>
                                ...
                                {!isCollateralError ? (
                                    <FormHelperText
                                        ...
                                        color="accent"
                                    >
                                        Enter the amount of <strong>BTC</strong>{' '}
                        ...
                        <VStack justifyContent="center">
                            <Text
                                ...
                                color={'#FF4500'}
                            >
                                You have 3 minutes to lock in your BTC after
                                setting up the loan, or the offer will expire.
                            </Text>
                            <Button
                                animation={
                                    showTutorial
